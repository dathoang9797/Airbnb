...
const Container = styled.div`
  ${tw`h-[96px] py-3 flex flex-col bg-white  px-20  items-center w-full  z-20 justify-between box-shadow[rgba(0, 0, 0, 0.08) 0px 1px 12px] font-family[Circular, -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica Neue', sans-serif]`};
