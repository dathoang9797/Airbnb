...
font-family[Circular, -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica Neue', sans-serif] sticky top-20 z-10 w-full inline-block pr-[1px] pb-12 max-w-[500px]
...
export const BookingDetailPriceCSS = {
  Container,
  Booking,
  BookingContent,
};
